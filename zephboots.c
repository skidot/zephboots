...
sys.stdout.write("\x1b]2;Z E P H B O O T S |CORT| S M U S H E D \x07")
def modifications():
...
info = """
[\033[91mSIN\033[00m] \033[91mZephboots, Made By Zeph, Re Coded from Zephboots,
i liked this scripts, so i simply re coded it,,
Zephboots Biggest Attack
50.0 gbps
Zephboots, Biggest Attack,
"""
...
║ \033[00mExit                          \033[91m|\033[00m EXIT Zephboots\033[91m           ║
...
║ \033[00mInfo                          \033[91m|\033[00m DISPLAY ZephbootsS INFO\033[91m  ║
╚════════════════════════════════════════════════════════╝\033[00m
"""
...
║ \033[00mStats                         \033[91m|\033[00m DISPLAY Zephboots STATS\033[91m║
╚════════════════════════════════════════════════════════╝\033[00m
"""
...
cookie = open(".Zephboots_cookie","w+")
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;Z E P H B O O T S\x07")
		sin = input("\033[1;00m[\033[91mZephboots\033[1;00m]-\033[91m家\033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (altbanner)
			...
			print ("ZEPHBOOTS version: "+version+" ")
		elif sinput == "stats":
			...
			sfound = 0
			sys.stdout.write("\x1b]2;Z E P H B O O T S |{}| F O U N D\x07".format (sfound))
			try:
				host = sin.split(" ")[1]
				with open(r"/usr/share/Zephboots/subnames.txt", "r") as sub:
			...
			try:
				...
				while True:
					try:
						...
						sys.stdout.write("\x1b]2;Z E P H B O O T S |{}ms| D E M O N S\x07".format (stop))
						print ("Zephboots: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("\x1b]2;Z E P H B O O T S |TIME OUT| D E M O N S\x07")
						print ("Zephboots: {}:{} [\033[91mDOWN\033[00m]".format(ip, port))
						time.sleep(1)
					except KeyboardInterrupt:
						print("")
						main()
